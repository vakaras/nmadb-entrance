...
latex_documents = [
  (
      'index', 'main.tex',
      u'\\nmadb-entrance Documentation', u'\\Vytautas Astrauskas', 'manual'
      ),
  ]
...
man_pages = [
    (
        'index', 'main',
        u'nmadb-entrance Documentation', [u'Vytautas Astrauskas'], 1,
        ),
    ]
...
pdf_documents = [
    (
        'index', u'main',
        u'nmadb-entrance Documentation', u'Vytautas Astrauskas'
        ),
    ]
